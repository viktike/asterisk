...
/*** MODULEINFO
	...
	<depend type="module">res_stasis_amqp</depend>
...
#include "resource_amqp/resource_amqp.h"
	...
	struct ast_variable *headers, struct ast_json *body, struct ast_ari_response *response)
{
	...
	case 501: /* Not Implemented */
	case 400: /* Bad request. */
	case 404: /* Stasis subscription not found */
		is_valid = 1;
		break;
	default:
		if (200 <= code && code <= 299) {
...
AST_MODULE_INFO(ASTERISK_GPL_KEY, AST_MODFLAG_DEFAULT, "RESTful API module - AMQP resource",
