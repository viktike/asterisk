...
#include "itu/g.729b/typedef.h"
#include "itu/g.729b/ld8a.h"
#include "itu/g.729b/g729a.h"
...
{
	struct g729_decoder_pvt *tmp = pvt->pvt;
...
{
	struct g729_encoder_pvt *tmp = pvt->pvt;
	g729a_encoder_init(&tmp->state, 0);
	return 0;
}
